 ...
 */
const cars: Car[] = [
  // Cars from PLANT-TOYOTA MOTOR MANUFACTURING to various dealers
  {
    vin: 'VF1000001ABC123',
    type: 'car',
    weight: 1500,
    pickupLocation: 'PLANT-TOYOTA MOTOR MANUFACTURING',
  ...
  // Cars from PLANT-RENAULT MAUBEUGE to various dealers
  {
    vin: 'VF1000009YZA567',
    type: 'car',
    weight: 1500,
    pickupLocation: 'PLANT-RENAULT MAUBEUGE',
